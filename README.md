...
Fora da sala de aula, meus projetos pessoais giram em torno de Rust e Linux, onde aprendo lidando com problemas reais: drivers de input, gerenciamento de configuração declarativa, automação de sistema e debugging de baixo nível.
